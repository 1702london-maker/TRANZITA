...
const SPECS = [
  ...
  { icon: '🔧', title: 'Local Maintenance Network', desc: 'Full maintenance partnerships with certified auto centres across Lagos, Abuja, and Port Harcourt.' },
  { icon: '🌍', title: 'Expanding Nationwide', desc: 'Currently serving Lagos and Abuja. Expanding to all 36 states by 2027 under the Tranzita franchise model.' },
]
...
export default function NigeriaFleet() {
  ...
  return (
    <section id="nigeria-fleet" ref={ref} className="py-24 px-4" style={{ background: '#F2F5F0' }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Partnering with{' '}
            <span style={{ color: '#E8601C' }}>made &amp; coupled in Nigeria</span>
            {' '}buses.
          </motion.h2>
          <motion.p
        ...
        >
          <div className="p-8">
            <div className="relative overflow-hidden rounded-2xl" style={{ background: '#F2F5F0', height: 140 }}>
              <div className="absolute bottom-0 left-0 right-0 h-8" style={{ background: '#DFF0DF' }} />
              <div className="absolute bottom-7 left-0 right-0 border-t-2 border-dashed" style={{ borderColor: '#8FA88F' }} />
              ...
              <div className="absolute car-drive" style={{ bottom: 8, left: 0 }}>
                <svg width="180" height="62" viewBox="0 0 180 62">
                  <rect x="4" y="6" width="158" height="42" fill="#E8601C" rx="9" />
                  <rect x="4" y="6" width="158" height="11" fill="#C85018" rx="9" />
                  ...
                  <rect x="2" y="40" width="162" height="5" fill="#B84815" rx="2" />
                  <circle cx="28" cy="54" r="8" fill="#1E2B1E" />
                  <circle cx="28" cy="54" r="3" fill="#8FA88F" />
                  <circle cx="136" cy="54" r="8" fill="#1E2B1E" />
                  <circle cx="136" cy="54" r="3" fill="#8FA88F" />
                  ...
                  <text x="7" y="37" fill="#1E2B1E" fontSize="6" fontWeight="800">EV</text>
                </svg>
              </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {SPECS.map((spec, i) => (
            ...
            >
              ...
              <h3 className="font-bold text-base mt-3 mb-2" style={{ color: '#1E2B1E' }}>{spec.title}</h3>
              <p className="text-sm leading-relaxed" style={{ color: '#6B7F6B' }}>{spec.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
