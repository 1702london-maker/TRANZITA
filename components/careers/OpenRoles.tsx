...
export default function OpenRoles() {
  return (
    <Section background="#F1F6EA" label="Open Roles" title="We are recruiting in Lagos." text="Abuja and Port Harcourt applicants can register interest ahead of launch. Every role requires the full six-stage vetting process. We guide you through every step.">
