...
const roles: Array<{ id: string; title: string; icon: LucideIcon; locations: string; apply: string; duties: string; needs: string; offers: string }> = [
  {
    ...
    title: 'Bus Driver',
    icon: Bus,
    locations: 'Lagos and Abuja now. Port Harcourt interest list.',
...
export default function OpenRoles() {
  return (
    <Section background="#F1F6EA" label="Open Roles" title="We are recruiting in Lagos and Abuja." text="Port Harcourt applicants can register interest ahead of launch. Every role requires the full six-stage vetting process. We guide you through every step.">
