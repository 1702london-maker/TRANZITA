...
const PHRASES = [
  { text: 'Every child.', color: '#183024' },
  { text: 'On time.', color: '#183024' },
  { text: 'Safe home.', color: '#D96B1F' },
]
...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Warm community-style background pattern */}
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div style={{
          ...
          border: '1px solid rgba(31,107,70,0.12)',
      ...
      <div className="absolute -bottom-4 sm:bottom-0 left-0 right-0 pointer-events-none overflow-hidden">
        <svg viewBox="0 0 1440 200" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" style={{ width: '100%', display: 'block' }}>
          ...
          {/* LAGOS */}
          <rect x="18" y="115" width="48" height="85" fill="#E5EEDB" rx="2" />
          <rect x="28" y="92" width="30" height="108" fill="#EDF5E5" rx="1" />
          <rect x="68" y="108" width="25" height="92" fill="#DDE9D2" rx="2" />
          <rect x="95" y="82" width="40" height="118" fill="#E5EEDB" rx="2" />
          <rect x="102" y="64" width="26" height="136" fill="#EDF5E5" rx="1" />
          ...
          {/* IBADAN */}
          <rect x="175" y="108" width="36" height="92" fill="#DDE9D2" rx="2" />
          <rect x="215" y="88" width="44" height="112" fill="#E5EEDB" rx="2" />
          <rect x="222" y="70" width="30" height="130" fill="#EDF5E5" rx="1" />
          <rect x="262" y="102" width="32" height="98" fill="#DDE9D2" rx="2" />
          ...
          {/* ABUJA */}
          <rect x="335" y="76" width="50" height="124" fill="#EDF5E5" rx="2" />
          <rect x="345" y="55" width="30" height="145" fill="#E5EEDB" rx="1" />
          <rect x="390" y="90" width="40" height="110" fill="#DDE9D2" rx="2" />
          <rect x="434" y="78" width="36" height="122" fill="#E5EEDB" rx="2" />
          <rect x="440" y="58" width="24" height="142" fill="#EDF5E5" rx="1" />
          ...
          {/* KANO */}
          <rect x="515" y="100" width="38" height="100" fill="#E5EEDB" rx="2" />
          <rect x="558" y="84" width="34" height="116" fill="#EDF5E5" rx="2" />
          <rect x="565" y="66" width="20" height="134" fill="#DDE9D2" rx="1" />
          <rect x="596" y="97" width="30" height="103" fill="#E5EEDB" rx="2" />
          ...
          {/* PORT HARCOURT */}
          <rect x="660" y="88" width="46" height="112" fill="#EDF5E5" rx="2" />
          <rect x="670" y="66" width="26" height="134" fill="#E5EEDB" rx="1" />
          <rect x="712" y="76" width="44" height="124" fill="#DDE9D2" rx="2" />
          <rect x="720" y="52" width="28" height="148" fill="#E5EEDB" rx="1" />
          <rect x="760" y="94" width="32" height="106" fill="#EDF5E5" rx="2" />
          ...
          {/* ENUGU */}
          <rect x="840" y="106" width="34" height="94" fill="#E5EEDB" rx="2" />
          <rect x="878" y="88" width="40" height="112" fill="#EDF5E5" rx="2" />
          <rect x="885" y="70" width="26" height="130" fill="#DDE9D2" rx="1" />
          <rect x="922" y="100" width="32" height="100" fill="#E5EEDB" rx="2" />
          ...
          {/* BENIN */}
          <rect x="998" y="94" width="38" height="106" fill="#DDE9D2" rx="2" />
          <rect x="1040" y="80" width="36" height="120" fill="#E5EEDB" rx="2" />
          <rect x="1047" y="62" width="22" height="138" fill="#EDF5E5" rx="1" />
          <rect x="1080" y="98" width="32" height="102" fill="#DDE9D2" rx="2" />
          ...
          {/* KADUNA */}
          <rect x="1142" y="104" width="36" height="96" fill="#E5EEDB" rx="2" />
          <rect x="1182" y="86" width="42" height="114" fill="#EDF5E5" rx="2" />
          <rect x="1189" y="66" width="28" height="134" fill="#DDE9D2" rx="1" />
          <rect x="1228" y="99" width="33" height="101" fill="#E5EEDB" rx="2" />
          ...
          {/* JOS */}
          <rect x="1295" y="110" width="34" height="90" fill="#EDF5E5" rx="2" />
          <rect x="1334" y="96" width="40" height="104" fill="#E5EEDB" rx="2" />
          <rect x="1340" y="78" width="28" height="122" fill="#DDE9D2" rx="1" />
          <rect x="1378" y="106" width="52" height="94" fill="#E5EEDB" rx="2" />
      ...
      {/* Main content */}
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center pb-28 sm:pb-24 lg:pb-20">
        <motion.div
        ...
        >
          ...
          Lagos Currently Served — Abuja &amp; Port Harcourt Coming Soon
        </motion.div>
        ...
        >
          <motion.a
            ...
            style={{ background: '#D96B1F', boxShadow: '0 4px 18px rgba(217,107,31,0.24)' }}
            whileHover={{ scale: 1.04, boxShadow: '0 8px 28px rgba(217,107,31,0.34)' }}
            whileTap={{ scale: 0.97 }}
          >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.02, borderColor: '#D96B1F', color: '#D96B1F' }}
            whileTap={{ scale: 0.97 }}
          >
            See How It Works
          </motion.a>
