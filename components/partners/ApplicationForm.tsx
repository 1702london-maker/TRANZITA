    ...
    const response = await fetch('/api/applications', {
      ...
      body: JSON.stringify({
        ...
        notes: [
          ...
          `EV product or service: ${form.get('EV Product Or Service')}`,
          `Current locations: ${form.get('Current Operating Locations')}`,
          `EV buses or charging sites: ${form.get('EV Buses Or Charging Sites')}`,
  ...
  return (
    <section id="apply" className="px-4 py-24" style={{ background: '#FFF9F2' }}>
      <div className="mx-auto max-w-5xl">
        <SectionIntro label="Apply Now" title="Tell us how you can support the Tranzita EV fleet." text="We review EV supply, charging, maintenance and fleet infrastructure partnerships. Private conventional cars are not accepted." />
        <motion.form onSubmit={submit} className="mt-12 rounded-[32px] bg-white p-6 sm:p-8" style={{ border: '1px solid #DDE9D2', boxShadow: '0 22px 60px rgba(31,107,70,0.08)' }} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <div className="grid gap-4 md:grid-cols-2">
            ...
            {[
              ...
              ['Partnership Type', ['EV Bus Assembly', 'EV Fleet Supply', 'Charging Infrastructure', 'EV Maintenance', 'Depot Or Property Infrastructure', 'Corporate Sponsorship']],
              ['EV Buses Or Charging Sites', ['1 to 3', '4 to 10', '11 to 25', '26 to 50', 'Over 50', 'Not applicable']],
              ['Made In Nigeria Capability', ['Already assembling locally', 'Local assembly partner in place', 'Can supply locally assembled EVs', 'Charging or maintenance support only']],
          ...
          <label className="mt-4 block text-sm font-bold" style={{ color: '#183024' }}>Tell us anything else about your EV partnership capacity
          ...
          <p className="mt-3 text-center text-xs" style={{ color: '#65785F' }}>We review every application. Tranzita only approves made-in-Nigeria EV fleet, charging, maintenance and infrastructure partnerships.</p>
