  ...
  return (
    <section className="px-4 py-24" style={{ background: '#FFF9F2' }}>
      <div className="mx-auto max-w-7xl">
        <SectionIntro label="The Partner Portal" title="Your dashboard for approved fleet work." text="Every Tranzita partner gets access to a dedicated portal with approved vehicle status, route history, earnings, fuel or charging readiness, and maintenance records." />
        <motion.div className="mx-auto mt-12 max-w-5xl rounded-[32px] bg-white p-6 shadow-sm" style={{ border: '1px solid #DDE9D2' }} initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}>
          <div className="grid gap-4 lg:grid-cols-3">
            {['Vehicle: Nigerian-Assembled School Bus - TRZ-P047', 'This Month: NGN 185,000', 'Next Payment: 1st September 2026'].map((item) => (
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-2">
            ...
            <div className="rounded-2xl p-5" style={{ background: '#F1F6EA' }}>
              ...
              <p className="mt-3 text-sm" style={{ color: '#65785F' }}>Last fleet inspection: Passed. Next maintenance and fuel-readiness review due: 15 August 2026. Outstanding items: None.</p>
            </div>
          </div>
        </motion.div>
      </div>
