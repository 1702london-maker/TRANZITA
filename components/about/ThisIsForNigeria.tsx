...
const lines = [
  'This is for the parent in Lekki who has called the driver four times and gotten no answer.',
  ...
  return (
    <section className="px-4 py-24" style={{ background: '#FFF9F2' }}>
      <div className="mx-auto max-w-5xl">
        <SectionIntro label="This Is For Nigeria" title="This is for every parent who ever stood at a gate wondering." subtitle="Built by people who understand the market, the roads, and the responsibility." />
