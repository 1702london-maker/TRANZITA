...
const verification: Array<[string, LucideIcon, string]> = [
  ...
  ['Visit Operations', ShieldCheck, 'School leaders can book Lagos or Abuja operations visits to inspect vehicles, charging and dispatch procedures. Port Harcourt visits open when that city launches.'],
