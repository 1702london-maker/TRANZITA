...
const cards = [
  ...
  ['Visit A Depot', MapPin, 'School administrators and principals can visit Lagos operations by appointment. Abuja and Port Harcourt visits will open when those cities launch.', 'Request A Depot Visit', '#demo-form', '#D96B1F'],
] as const
