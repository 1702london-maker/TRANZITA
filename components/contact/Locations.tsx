...
const locations = [
  ...
  ['Abuja Coming Soon', 'Coming soon. Abuja schools and parents can register interest now so route planning can begin before launch.'],
...
export default function Locations() {
  return (
    <Section background="#FFF9F2" label="Where We Are" title="Operating in Lagos." text="Abuja and Port Harcourt are coming soon. Other cities can register interest for future route planning.">
      ...
      <div className="mt-8 rounded-2xl p-7 text-white text-center font-bold" style={{ background: 'linear-gradient(90deg, #1F6B46 0%, #D96B1F 100%)' }}>Now operating in Lagos. Abuja and Port Harcourt are coming soon.</div>
    </Section>
  )
}
