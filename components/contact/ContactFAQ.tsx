...
const faqs = [
  ...
  ['Is Tranzita available in my city?', 'Tranzita currently serves Lagos. Abuja and Port Harcourt are coming soon. Other cities can register interest and the team will contact you when route planning opens there.'],
  ...
  ['Can we visit a depot before signing?', 'Yes. School administrators and principals can visit the Lagos operations hub by appointment. Abuja and Port Harcourt visits will open when those cities launch. Contact the team via email or WhatsApp to arrange a visit.'],
