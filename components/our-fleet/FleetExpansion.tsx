...
export default function FleetExpansion() {
  return (
    <Section background="#FFF9F2" label="Fleet Expansion" title="Lagos is live. Abuja and Port Harcourt are next." text="Tranzita is operating in Lagos, with Abuja and Port Harcourt coming soon and other cities tracked as future interest areas.">
