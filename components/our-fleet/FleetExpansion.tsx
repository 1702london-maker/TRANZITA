...
export default function FleetExpansion() {
  return (
    <Section background="#FFF9F2" label="Fleet Expansion" title="Lagos and Abuja are live. Port Harcourt is next." text="Tranzita is operating in Lagos and Abuja, with Port Harcourt coming soon and other cities tracked as future interest areas.">
      <div className="grid lg:grid-cols-[1fr_0.9fr] gap-10 items-center">
        ...
        <div className="space-y-4">
          {[
            ['Currently Operating', 'Lagos and Abuja are the current live service areas for Tranzita school routes.'],
            ['Coming Soon', 'Port Harcourt is the next launch city. Schools can register interest ahead of route planning.'],
