...
const cities = [
  ...
  ['Abuja', 260, 166, 'Operating'],
  ['Port Harcourt', 286, 260, 'Expanding'],
...
export default function FleetExpansion() {
  return (
    <Section background="#FFF9F2" label="Fleet Expansion" title="Growing to serve every Nigerian city that needs safer school transport." text="Tranzita is operating in Lagos and Abuja, with expansion underway across major Nigerian cities.">
      <div className="grid lg:grid-cols-[1fr_0.9fr] gap-10 items-center">
        ...
        <div className="space-y-4">
          {[
            ['Currently Operating', 'Lagos and Abuja are fully operational across major school districts and FCT school zones.'],
            ['Expanding Next', 'Port Harcourt deployment is underway, Ibadan route mapping is in progress, and Kano school partner onboarding has started.'],
            ['Nationwide Model', 'Enugu, Benin City, Kaduna, Jos and Warri follow, with franchise expansion toward all 36 states.'],
