...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/schools', destination: '/dashboard/school', permanent: false },
      { source: '/parents', destination: '/dashboard/parent', permanent: false },
      { source: '/drivers', destination: '/dashboard/driver', permanent: false },
    ]
  },
  async headers() {
    return [
