...
export const workQueueRows = [
  ...
  ['Fleet partner document', 'Fleet', 'Due Friday', 'Medium'],
...
const scopedRows: Partial<Record<DashboardRole, Partial<DashboardPayload>>> = {
  ...
  Partner: {
    tableRows: [
      ['TRZ-P011', 'Approved Tranzita route', 'Children onboard count: 12', 'Certified vehicle', 'No child names', 'Active'],
      ['TRZ-P018', 'Approved Tranzita route', 'Children onboard count: 9', 'Inspection due', 'No parent data', 'Active'],
      ['TRZ-P023', 'Backup pool', 'Children onboard count: 0', 'Certified vehicle', 'No school private data', 'Available'],
    ],
    manifestRows: [
